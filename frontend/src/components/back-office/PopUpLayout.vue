<template>    
    <div class="back-office--container__popUp" :style="'opacity: '+this.opacity+';z-index:'+this.zindex">
        <section class="back-office--popUp">
            <div><img v-bind:src="wait" alt=""></div>
            <div class="back-office--popUp__title">Supprimer definitivement cet élement ?</div>
            <div class="back-office--popUp__response">
                <div class="back-office--popUp__yes"><img v-bind:src="yes" v-on:click="hiddenPopUp" name="yes" alt=""></div>
                <div class="back-office--popUp__no"><img v-bind:src="no" v-on:click="hiddenPopUp" name="no" alt=""></div>
            </div>                
        </section>
    </div>
</template>
